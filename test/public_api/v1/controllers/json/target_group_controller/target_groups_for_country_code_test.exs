defmodule Test.PublicAPI.V1.Controllers.JSON.TargetGroupController.TargetGroupsForCountryCodeTest do
  ...
  describe "responding with TargetGroups matching the Country's PanelProvider" do
    test "when target_groups/:country_code called with a valid :country_code", %{
      ...
      conn = get(conn, ~p"/public_api/v1/target_groups/#{country_code}")
