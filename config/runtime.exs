...
#
#     PHX_SERVER=true bin/devtest_elixir start
#
...
if config_env() == :prod do
  ...
  config :devtest_elixir, PrivateAPI.Endpoint,
    ...
    http: [
      ...
      ip: {0, 0, 0, 0, 0, 0, 0, 0},
      port: System.get_env("PRIVATE_API_PORT")
    ],
  ...
  config :devtest_elixir, PublicAPI.Endpoint,
    ...
    http: [
      ...
      # for details about using IPv6 vs IPv4 and loopback vs public addresses.
      ip: {0, 0, 0, 0, 0, 0, 0, 0},
      port: System.get_env("PUBLIC_API_PORT")
    ],
    secret_key_base: secret_key_base
  ...
  #
  #     config :devtest_elixir, DevtestElixir.Mailer,
